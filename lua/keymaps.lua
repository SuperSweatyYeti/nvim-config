...
-- TreeSitter Rainbow Brackets refresh
keymap("n", "<leader>r", "<cmd>TSToggle rainbow<CR><cmd>TSToggle rainbow<CR>", opts)
-- TreeSitter Syntax highlights Toggle
keymap("n", "<leader>th", "<cmd>TSToggle highlight<CR>", opts)
...
keymap("n", "<leader>fo", ":NvimTreeOpen ", opts)
